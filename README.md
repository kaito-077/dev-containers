...
4. このリポジトリをForkして `git clone` しておく
...
> どちらの設定で開いても、裏側では frontend / backend / db の**3つすべてのコンテナ**が同時に起動しています。片方の窓で作業していても、もう片方のコンテナは動き続けています。※アプリの実行はそれぞれのコマンドを実行する必要があります。
